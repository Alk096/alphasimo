# Generated by Django 6.0.4 on 2026-05-06 20:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('programme_souhaiter', models.CharField(choices=[('QSE', ' QSE Qualifiant'), ('Management', 'Management des Processus'), ('Audit', 'Audit Interne')], max_length=100)),
                ('session_preferee', models.DateField()),
                ('lieu_souhaiter', models.CharField(choices=[('Lomé', 'Lomé'), ('Tunis', 'Tunis')], max_length=100)),
